<p align="center">
    <a href="https://github.com/codicastudio" target="_blank">
...
[![Build Status](https://travis-ci.org/codicastudio/seotools.svg)](https://travis-ci.org/codicastudio/seotools)
[![Code Climate](https://codeclimate.com/github/codicastudio/seotools/badges/gpa.svg)](https://codeclimate.com/github/codicastudio/seotools)

> Statistics

[![Latest Stable Version](https://poser.pugx.org/codicastudio/seotools/v/stable)](https://packagist.org/packages/codicastudio/seotools) [![Total Downloads](https://poser.pugx.org/codicastudio/seotools/downloads)](https://packagist.org/packages/codicastudio/seotools) [![Latest Unstable Version](https://poser.pugx.org/codicastudio/seotools/v/unstable)](https://packagist.org/packages/codicastudio/seotools) [![License](https://poser.pugx.org/codicastudio/seotools/license)](https://packagist.org/packages/codicastudio/seotools)
...
```shell
composer require codicastudio/seotools
```
...
return [
    // ...
    'providers' => [
        codicastudio\SEOTools\Providers\SEOToolsServiceProvider::class,
        // ...
    ],
    // ...
];
...
You may get access to the SEO tool services using following facades:
 ...
 - `codicastudio\SEOTools\Facades\SEOMeta`
 - `codicastudio\SEOTools\Facades\OpenGraph`
 - `codicastudio\SEOTools\Facades\TwitterCard`
 - `codicastudio\SEOTools\Facades\JsonLd`
 - `codicastudio\SEOTools\Facades\JsonLdMulti`
 - `codicastudio\SEOTools\Facades\SEOTools`
...
return [
    // ...
    'aliases' => [
        'SEOMeta'       => codicastudio\SEOTools\Facades\SEOMeta::class,
        'OpenGraph'     => codicastudio\SEOTools\Facades\OpenGraph::class,
        'Twitter'       => codicastudio\SEOTools\Facades\TwitterCard::class,
        'JsonLd'        => codicastudio\SEOTools\Facades\JsonLd::class,
        'JsonLdMulti'   => codicastudio\SEOTools\Facades\JsonLdMulti::class,
        // or
        'SEO' => codicastudio\SEOTools\Facades\SEOTools::class,
        // ...
    ],
    // ...
];
...
```shell
php artisan vendor:publish --provider="codicastudio\SEOTools\Providers\SEOToolsServiceProvider"
```
...
use codicastudio\SEOTools\Facades\SEOMeta;
use codicastudio\SEOTools\Facades\OpenGraph;
use codicastudio\SEOTools\Facades\TwitterCard;
use codicastudio\SEOTools\Facades\JsonLd;
// OR with multi
use codicastudio\SEOTools\Facades\JsonLdMulti;
...
use codicastudio\SEOTools\Traits\SEOTools as SEOToolsTrait;
