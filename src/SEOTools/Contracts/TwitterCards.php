 ...
 *
 * ```php
 * use codicastudio\SEOTools\TwitterCards; // implements `codicastudio\SEOTools\Contracts\TwitterCards`
 *
 ...
 * ```
 *
 * Implementation of this contract is available via {@see \codicastudio\SEOTools\Facades\TwitterCard} facade.
 ...
 * @see \codicastudio\SEOTools\TwitterCards
 * @see \codicastudio\SEOTools\Facades\TwitterCard
 */
