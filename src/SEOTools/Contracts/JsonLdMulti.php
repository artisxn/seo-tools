 ...
 * Usage example:
 * ```php
 * use codicastudio\SEOTools\JsonLdMulti; // implements `codicastudio\SEOTools\Contracts\JsonLdMulti`
 ...
 * ```
 * Implementation of this contract is available via {@see \codicastudio\SEOTools\Facades\JsonLdMulti} facade.
 ...
 * @see \codicastudio\SEOTools\JsonLdMulti
 * @see \codicastudio\SEOTools\Facades\JsonLdMulti
 */
