 ...
 *
 * ```php
 * use codicastudio\SEOTools\OpenGraph; // implements `codicastudio\SEOTools\Contracts\OpenGraph`
 *
 ...
 * ```
 *
 * Implementation of this contract is available via {@see \codicastudio\SEOTools\Facades\OpenGraph} facade.
 ...
 *
 * @see https://ogp.me/
 * @see \codicastudio\SEOTools\OpenGraph
 * @see \codicastudio\SEOTools\Facades\OpenGraph
 */
interface OpenGraph
{
    /**
