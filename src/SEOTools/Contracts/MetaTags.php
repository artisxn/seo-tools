 ...
 *
 * ```php
 * use codicastudio\SEOTools\SEOMeta; // implements `codicastudio\SEOTools\Contracts\MetaTags`
 *
 ...
 * ```
 *
 * Implementation of this contract is available via {@see \codicastudio\SEOTools\Facades\SEOMeta} facade.
 ...
 * @see \codicastudio\SEOTools\SEOMeta
 * @see \codicastudio\SEOTools\Facades\SEOMeta
 */
interface MetaTags
{
    /**
