...
class JsonLdTest extends BaseTest
{
    ...
    public function test_array_add_value()
    {
        $this->jsonLd->addValue('author', [
            '@type' => 'Organization',
            'name' => 'SeoTools',
            'url' => 'https://github.com/codicastudio/seotools',
        ]);

        $expected = '<html><head><script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"WebPage","name":"Over 9000 Thousand!","description":"For those who helped create the Genki Dama","author":{"@type":"Organization","name":"SeoTools","url":"https:\/\/github.com\/codicastudio\/seotools"}}</script></head></html>';
